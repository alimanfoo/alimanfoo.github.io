...
Note that the 'ALT' field has been broken into three separate column, labelled 'ALT_1', 'ALT_2' and 'ALT_3'. When loading data into a data frame, any field with multiple values will be broken into multiple columns in this way.
...
{% highlight python %}
df = allel.vcf_to_dataframe('example.vcf', fields='*', 
                            numbers={'ALT': 2, 'AF': 2, 'svlen': 2})
df
{% endhighlight %}
...
If you prefer to work with NumPy structured arrays rather than pandas DataFrames, try the [`vcf_to_recarray()`](@@TODO) function, e.g.: 
...
Finally, the [`vcf_to_csv()`](@@TODO) function is available if you need to dump data from a VCF file out to a generic CSV file (e.g., to load into a database). E.g.:
...
This function uses the pandas [`to_csv()`](@@TODO) function under the hood to write the CSV, so you can control various output parameters (e.g., field separator) by passing through keyword arguments.
...
{% endhighlight %}
    ...
    total 527M
    drwxrwxr-x 2 aliman aliman 4.0K Oct 14  2016 2015-09-15
    drwxrwxr-x 2 aliman aliman 4.0K Oct 14  2016 2015-09-21
    drwxrwxr-x 2 aliman aliman 4.0K Oct 14  2016 2015-09-28
    drwxrwxr-x 2 aliman aliman 4.0K Oct 18  2016 2016-04-14
    drwxrwxr-x 2 aliman aliman 4.0K Jan 17 22:37 2016-05-16
    drwxrwxr-x 2 aliman aliman 4.0K Oct 18  2016 2016-06-10
    drwxrwxr-x 2 aliman aliman 4.0K Oct 18  2016 2016-06-21
    drwxr-xr-x 2 aliman aliman 4.0K Jan 25 20:33 2017-01-25
    drwxr-xr-x 2 aliman aliman 4.0K Feb 14 09:52 2017-02-14
    -r--r--r-- 1 aliman aliman 2.6M Jan 25 20:34 Anopheles-gambiae-PEST_BASEFEATURES_AgamP4.4.gff3.gz
    -r--r--r-- 1 aliman aliman 264M Jan 26 11:16 Anopheles-gambiae-PEST_CHROMOSOMES_AgamP4.fa
    -r--r--r-- 1 aliman aliman  220 Jan 26 11:16 Anopheles-gambiae-PEST_CHROMOSOMES_AgamP4.fa.fai
    -r--r--r-- 1 aliman aliman 261M Jan 26 11:16 Anopheles-gambiae-PEST_CHROMOSOMES_AgamP4.fa.flat
    -r--r--r-- 1 aliman aliman  158 Jan 26 11:16 Anopheles-gambiae-PEST_CHROMOSOMES_AgamP4.fa.gdx
    -r--r--r-- 1 aliman aliman   79 Jan 26 11:16 Anopheles-gambiae-PEST_CHROMOSOMES_AgamP4.fa.md5
    lrwxrwxrwx 1 aliman aliman   44 Jan 25 20:40 davies_vgsc_model_20170125.gff3 -> ../../assets/davies_vgsc_model_20170125.gff3
    lrwxrwxrwx 1 aliman aliman   40 Feb 14 10:03 phase1.AR3 -> /kwiat/vector/ag1000g/release/phase1.AR3
    lrwxrwxrwx 1 aliman aliman   42 Feb 14 09:53 phase1.AR3.1 -> /kwiat/vector/ag1000g/release/phase1.AR3.1
