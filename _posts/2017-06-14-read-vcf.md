...
{% endhighlight %}
    ...
    <numpy.lib.npyio.NpzFile at 0x7f2b4a6185c0>
...
{% endhighlight %}
    ...
    [vcf_to_hdf5] 65536 rows in 10.72s; chunk in 10.72s (6111 rows/s); 22 :18539397
    [vcf_to_hdf5] 131072 rows in 24.19s; chunk in 13.47s (4866 rows/s); 22 :21016127
    [vcf_to_hdf5] 196608 rows in 37.99s; chunk in 13.80s (4747 rows/s); 22 :23236362
    [vcf_to_hdf5] 262144 rows in 52.44s; chunk in 14.44s (4537 rows/s); 22 :25227844
    [vcf_to_hdf5] 327680 rows in 68.59s; chunk in 16.15s (4058 rows/s); 22 :27285434
    [vcf_to_hdf5] 393216 rows in 83.18s; chunk in 14.60s (4489 rows/s); 22 :29572822
    [vcf_to_hdf5] 458752 rows in 97.90s; chunk in 14.71s (4453 rows/s); 22 :31900536
    [vcf_to_hdf5] 524288 rows in 112.71s; chunk in 14.82s (4423 rows/s); 22 :34069864
    [vcf_to_hdf5] 589824 rows in 127.00s; chunk in 14.29s (4585 rows/s); 22 :36053392
    [vcf_to_hdf5] 655360 rows in 141.39s; chunk in 14.39s (4554 rows/s); 22 :38088395
    [vcf_to_hdf5] 720896 rows in 155.37s; chunk in 13.97s (4690 rows/s); 22 :40216200
    [vcf_to_hdf5] 786432 rows in 169.27s; chunk in 13.90s (4713 rows/s); 22 :42597446
    [vcf_to_hdf5] 851968 rows in 183.70s; chunk in 14.43s (4541 rows/s); 22 :44564263
    [vcf_to_hdf5] 917504 rows in 198.31s; chunk in 14.61s (4484 rows/s); 22 :46390672
    [vcf_to_hdf5] 983040 rows in 213.19s; chunk in 14.88s (4405 rows/s); 22 :48116697
    [vcf_to_hdf5] 1048576 rows in 228.55s; chunk in 15.36s (4266 rows/s); 22 :49713436
    [vcf_to_hdf5] 1103547 rows in 241.36s; chunk in 12.81s (4292 rows/s); :0
    [vcf_to_hdf5] all done (4520 rows/s)
...
{% endhighlight %}
    ...
    -rw-r--r-- 1 aliman aliman 639M Jul  3 19:13 data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.h5
...
{% endhighlight %}
    ...
    CPU times: user 53.3 s, sys: 576 ms, total: 53.9 s
    Wall time: 33.5 s
...
{% endhighlight %}
    ...
    [vcf_to_zarr] 65536 rows in 10.93s; chunk in 10.93s (5998 rows/s); 22 :18539397
    [vcf_to_zarr] 131072 rows in 22.64s; chunk in 11.71s (5596 rows/s); 22 :21016127
    [vcf_to_zarr] 196608 rows in 35.09s; chunk in 12.45s (5263 rows/s); 22 :23236362
    [vcf_to_zarr] 262144 rows in 47.44s; chunk in 12.36s (5303 rows/s); 22 :25227844
    [vcf_to_zarr] 327680 rows in 59.69s; chunk in 12.25s (5351 rows/s); 22 :27285434
    [vcf_to_zarr] 393216 rows in 72.02s; chunk in 12.33s (5313 rows/s); 22 :29572822
    [vcf_to_zarr] 458752 rows in 84.29s; chunk in 12.27s (5341 rows/s); 22 :31900536
    [vcf_to_zarr] 524288 rows in 96.30s; chunk in 12.01s (5458 rows/s); 22 :34069864
    [vcf_to_zarr] 589824 rows in 108.50s; chunk in 12.21s (5368 rows/s); 22 :36053392
    [vcf_to_zarr] 655360 rows in 121.12s; chunk in 12.61s (5196 rows/s); 22 :38088395
    [vcf_to_zarr] 720896 rows in 133.68s; chunk in 12.57s (5215 rows/s); 22 :40216200
    [vcf_to_zarr] 786432 rows in 146.03s; chunk in 12.35s (5306 rows/s); 22 :42597446
    [vcf_to_zarr] 851968 rows in 158.33s; chunk in 12.30s (5329 rows/s); 22 :44564263
    [vcf_to_zarr] 917504 rows in 170.52s; chunk in 12.19s (5375 rows/s); 22 :46390672
    [vcf_to_zarr] 983040 rows in 182.54s; chunk in 12.02s (5450 rows/s); 22 :48116697
    [vcf_to_zarr] 1048576 rows in 195.26s; chunk in 12.72s (5154 rows/s); 22 :49713436
    [vcf_to_zarr] 1103547 rows in 207.47s; chunk in 12.21s (4501 rows/s); :0
    [vcf_to_zarr] all done (5297 rows/s)
...
{% endhighlight %}
    ...
    CPU times: user 27.2 s, sys: 124 ms, total: 27.3 s
    Wall time: 3.68 s
...
If you have a VCF with annotations from SNPEFF, you can post-process these to extract out data from within the ANN annotations. For example, here's a trivial VCF with SNPEFF annotations:
...
This probably looks like a fruit salad, but the main thing to note is that the values of the ANN field contain multiple sub-fields. E.g., in the first variant, the ANN value is "T|intergenic_region|MODIFIER|AGAP004677|AGAP004677|intergenic_region|AGAP004677||||||||3000|". The sub-fields are delimited by the pipe character ("|"). The first sub-field gives the allele to which the effect annotation applies ("T"); the second sub-field gives the actually annotation ("intergenic_region"); etc.
...
However, like this the data aren't much use. If you want to access the sub-fields, scikit-allele provides a **transformers** parameter, which can be used like this:
...
Note that even though I only requested the "ANN" field, the resulting callset has a number of fields, each of which represents the sub-fields from the ANN annotation. E.g.:
