...
{% endhighlight %}
    ...
    <numpy.lib.npyio.NpzFile at 0x7fcf08dd4128>
...
{% highlight python %}
allel.vcf_to_hdf5('example.vcf', 'example_types.h5', 
                  fields=['CHROM', 'ID'],
...
To access the saved data, there's a couple of lines of configuration code you need to run first to deal with how variable length strings are stored (which won't be necessary from Zarr 2.2 on, hopefully released soon):  
...
I've downloaded a [VCF file](ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz) with genotype data for Chromosome 22 from the 1000 genomes project phase 3 [FTP site](ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/). This file is reasonable large, before we start processing let's see how big it is (the '!' is special Jupyter notebook syntax for running a command via the operating system shell):


{% highlight python %}
!ls -lh data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz
{% endhighlight %}

    -rw-r--r-- 1 aliman aliman 205M Jun 20 11:23 data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz
...
{% endhighlight %}
    ...
    [read_vcf] 65536 rows in 5.27s; chunk in 5.27s (12439 rows/s); 22 :18539397
    [read_vcf] 131072 rows in 10.30s; chunk in 5.03s (13027 rows/s); 22 :21016127
    [read_vcf] 196608 rows in 15.36s; chunk in 5.06s (12960 rows/s); 22 :23236362
    [read_vcf] 262144 rows in 20.37s; chunk in 5.02s (13057 rows/s); 22 :25227844
    [read_vcf] 327680 rows in 25.42s; chunk in 5.04s (12991 rows/s); 22 :27285434
    [read_vcf] 393216 rows in 30.43s; chunk in 5.01s (13083 rows/s); 22 :29572822
    [read_vcf] 458752 rows in 35.48s; chunk in 5.05s (12978 rows/s); 22 :31900536
    [read_vcf] 524288 rows in 40.51s; chunk in 5.03s (13018 rows/s); 22 :34069864
    [read_vcf] 589824 rows in 45.57s; chunk in 5.06s (12962 rows/s); 22 :36053392
    [read_vcf] 655360 rows in 50.58s; chunk in 5.01s (13078 rows/s); 22 :38088395
    [read_vcf] 720896 rows in 55.58s; chunk in 5.00s (13097 rows/s); 22 :40216200
    [read_vcf] 786432 rows in 60.63s; chunk in 5.05s (12970 rows/s); 22 :42597446
    [read_vcf] 851968 rows in 65.71s; chunk in 5.07s (12921 rows/s); 22 :44564263
    [read_vcf] 917504 rows in 70.75s; chunk in 5.04s (12994 rows/s); 22 :46390672
    [read_vcf] 983040 rows in 75.77s; chunk in 5.02s (13053 rows/s); 22 :48116697
    [read_vcf] 1048576 rows in 80.82s; chunk in 5.05s (12973 rows/s); 22 :49713436
    [read_vcf] 1103547 rows in 85.04s; chunk in 4.22s (13024 rows/s)
    [read_vcf] all done (12976 rows/s)
...
{% endhighlight %}
    ...
    [vcf_to_hdf5] 65536 rows in 10.76s; chunk in 10.76s (6087 rows/s); 22 :18539397
    [vcf_to_hdf5] 131072 rows in 24.42s; chunk in 13.66s (4798 rows/s); 22 :21016127
    [vcf_to_hdf5] 196608 rows in 38.05s; chunk in 13.63s (4808 rows/s); 22 :23236362
    [vcf_to_hdf5] 262144 rows in 51.67s; chunk in 13.62s (4812 rows/s); 22 :25227844
    [vcf_to_hdf5] 327680 rows in 65.22s; chunk in 13.55s (4836 rows/s); 22 :27285434
    [vcf_to_hdf5] 393216 rows in 78.77s; chunk in 13.55s (4836 rows/s); 22 :29572822
    [vcf_to_hdf5] 458752 rows in 92.28s; chunk in 13.50s (4853 rows/s); 22 :31900536
    [vcf_to_hdf5] 524288 rows in 105.89s; chunk in 13.62s (4812 rows/s); 22 :34069864
    [vcf_to_hdf5] 589824 rows in 119.45s; chunk in 13.56s (4833 rows/s); 22 :36053392
    [vcf_to_hdf5] 655360 rows in 133.03s; chunk in 13.58s (4827 rows/s); 22 :38088395
    [vcf_to_hdf5] 720896 rows in 146.51s; chunk in 13.49s (4859 rows/s); 22 :40216200
    [vcf_to_hdf5] 786432 rows in 159.95s; chunk in 13.44s (4877 rows/s); 22 :42597446
    [vcf_to_hdf5] 851968 rows in 173.37s; chunk in 13.42s (4882 rows/s); 22 :44564263
    [vcf_to_hdf5] 917504 rows in 187.03s; chunk in 13.66s (4798 rows/s); 22 :46390672
    [vcf_to_hdf5] 983040 rows in 200.68s; chunk in 13.65s (4801 rows/s); 22 :48116697
    [vcf_to_hdf5] 1048576 rows in 214.22s; chunk in 13.54s (4840 rows/s); 22 :49713436
    [vcf_to_hdf5] 1103547 rows in 226.31s; chunk in 12.09s (4548 rows/s)
    [vcf_to_hdf5] all done (4821 rows/s)


Take a look at the resulting file size:


{% highlight python %}
!ls -lh data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.h5
{% endhighlight %}

    -rw-r--r-- 1 aliman aliman 639M Jul  4 15:40 data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.h5


You'll notice this file is quite a lot bigger (639M) than the original VCF (205M). This is because HDF5 is very inefficient at storing variable length strings, which come from columns like CHROM, ID, REF, ALT, and INFO fields like AA and SVTYPE. If file size is an issue, you can work around this by setting fixed length string types for these fields via the **types** parameter as described above. Alternatively you could try Zarr (see below). 
...
![png](/assets/2017-06-14-read-vcf_files/2017-06-14-read-vcf_163_0.png)
...
{% endhighlight %}
    ...
    CPU times: user 48.1 s, sys: 784 ms, total: 48.9 s
    Wall time: 30.2 s


### Extract to Zarr

For comparison, let's also extract the same data to Zarr:


{% highlight python %}
allel.vcf_to_zarr('data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz',
                  'data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.zarr',
                  fields='*', alt_number=8, log=sys.stdout, 
                  compressor=zarr.Blosc(cname='zstd', clevel=1, shuffle=False))
{% endhighlight %}

    [vcf_to_zarr] 65536 rows in 10.74s; chunk in 10.74s (6104 rows/s); 22 :18539397
    [vcf_to_zarr] 131072 rows in 21.97s; chunk in 11.23s (5834 rows/s); 22 :21016127
    [vcf_to_zarr] 196608 rows in 33.23s; chunk in 11.26s (5818 rows/s); 22 :23236362
    [vcf_to_zarr] 262144 rows in 44.49s; chunk in 11.26s (5822 rows/s); 22 :25227844
    [vcf_to_zarr] 327680 rows in 55.71s; chunk in 11.22s (5840 rows/s); 22 :27285434
    [vcf_to_zarr] 393216 rows in 66.97s; chunk in 11.26s (5820 rows/s); 22 :29572822
    [vcf_to_zarr] 458752 rows in 78.24s; chunk in 11.27s (5814 rows/s); 22 :31900536
    [vcf_to_zarr] 524288 rows in 89.45s; chunk in 11.21s (5843 rows/s); 22 :34069864
    [vcf_to_zarr] 589824 rows in 100.74s; chunk in 11.29s (5805 rows/s); 22 :36053392
    [vcf_to_zarr] 655360 rows in 111.93s; chunk in 11.19s (5858 rows/s); 22 :38088395
    [vcf_to_zarr] 720896 rows in 123.14s; chunk in 11.21s (5846 rows/s); 22 :40216200
    [vcf_to_zarr] 786432 rows in 134.32s; chunk in 11.18s (5859 rows/s); 22 :42597446
    [vcf_to_zarr] 851968 rows in 145.51s; chunk in 11.19s (5855 rows/s); 22 :44564263
    [vcf_to_zarr] 917504 rows in 156.79s; chunk in 11.28s (5811 rows/s); 22 :46390672
    [vcf_to_zarr] 983040 rows in 168.00s; chunk in 11.21s (5847 rows/s); 22 :48116697
    [vcf_to_zarr] 1048576 rows in 179.32s; chunk in 11.32s (5789 rows/s); 22 :49713436
    [vcf_to_zarr] 1103547 rows in 188.86s; chunk in 9.54s (5762 rows/s)
    [vcf_to_zarr] all done (5829 rows/s)


By default Zarr will compress data using LZ4 via the Blosc compression library, however here I've decided to use Zstandard instead of LZ4. LZ4 is faster but has slightly lower compression ratio, so is a good option if disk space is not a major issue and you are working from a storage device with high bandwidth (e.g., an SSD). Zstd is slightly slower but compresses a bit better.

Zarr stores the data in multiple files within a directory hierarchy. How much storage is required in total?


{% highlight python %}
!du -hs data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.zarr
{% endhighlight %}

    139M	data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.zarr


For comparison, run the allele count computation:


{% highlight python %}
callset_h1k = zarr.open_group('data/ALL.chr22.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.zarr',
                              mode='r')
gt = allel.GenotypeDaskArray(callset_h1k['calldata/GT'])
gt
{% endhighlight %}
...
{% endhighlight %}
    ...
    CPU times: user 27.6 s, sys: 332 ms, total: 27.9 s
    Wall time: 3.84 s


So Zarr uses a lot less space on disk than HDF5, and is a lot faster to compute over, primarily because it supports multi-threaded access. 
