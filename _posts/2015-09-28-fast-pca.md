...
<table class='petl'>
<caption>GenotypeChunkedArray((4825329, 765, 2), int8, nbytes=6.9G, cbytes=394.8M, cratio=17.8, cname=blosclz, clevel=5, shuffle=True, chunks=(1370, 765, 2), data=bcolz.carray_ext.carray)</caption>
<thead>
<tr>
<th></th>
<th>0</th>
...
{% endhighlight %}
    ...
    ChunkedArray((4825329, 765), int8, nbytes=3.4G, cbytes=301.5M, cratio=11.7, cname=blosclz, clevel=5, shuffle=True, chunks=(2741, 765), data=bcolz.carray_ext.carray)
...
{% endhighlight %}
    ...
    ChunkedArray((100000, 765), int8, nbytes=73.0M, cbytes=6.7M, cratio=10.9, cname=blosclz, clevel=5, shuffle=True, chunks=(685, 765), data=bcolz.carray_ext.carray)
...
{% endhighlight %}
    ...
    iteration 1 retaining 56477 removing 43523 variants
    iteration 2 retaining 47385 removing 9092 variants
    iteration 3 retaining 44462 removing 2923 variants
    iteration 4 retaining 43102 removing 1360 variants
    iteration 5 retaining 42295 removing 807 variants
    iteration 6 retaining 41832 removing 463 variants
    iteration 7 retaining 41507 removing 325 variants
    iteration 8 retaining 41275 removing 232 variants
    iteration 9 retaining 41104 removing 171 variants
    iteration 10 retaining 40953 removing 151 variants


10 iterations is probably way more than necessary for this dataset, as you can see not many SNPs are removed in the last five iterations.
...
{% endhighlight %}
    ...
    iteration 1 retaining 75524 removing 24476 variants
...
![png](/assets/2015-09-28-fast-pca_files/2015-09-28-fast-pca_59_0.png)
...
![png](/assets/2015-09-28-fast-pca_files/2015-09-28-fast-pca_63_0.png)
...
![png](/assets/2015-09-28-fast-pca_files/2015-09-28-fast-pca_68_0.png)
...
{% highlight python %}
%memit allel.stats.pca(gnu, n_components=10, scaler='patterson');
{% endhighlight %}

    peak memory: 3133.23 MiB, increment: 540.24 MiB



{% highlight python %}
%memit allel.stats.randomized_pca(gnu, n_components=10, scaler='patterson');
{% endhighlight %}

    peak memory: 2894.36 MiB, increment: 298.79 MiB
...
* Randomized PCA produces results that are almost indistinguishable from conventional PCA, while running faster and using less memory.
...
![png](/assets/2015-09-28-fast-pca_files/2015-09-28-fast-pca_79_0.png)
...
![png](/assets/2015-09-28-fast-pca_files/2015-09-28-fast-pca_81_0.png)
